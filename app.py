...
GOOGLE_CLIENT_ID = "51108204880-qs0qo26r5fi1uaqql4k2o54lat9etmsk.apps.googleusercontent.com" 
...
app.config['MONGO_URI']= "mongodb://localhost:27017/resumeparsing"          #Enter mongo db uri here
mongo.init_app(app)
